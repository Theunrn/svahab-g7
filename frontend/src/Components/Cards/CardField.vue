    ...
    <div class="flex justify-center">
        ...
        <div class="card-wrapper relative w-full sm:w-1/4 mx-2 my-5" v-for="index in 4" :key="index">
          <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-4 relative z-10">
              <!-- Card Title -->
              <router-link :to="{ name: 'Detail', params: { id: index } }">
                <h5 class="mb-2 text-2xl text-info font-bold tracking-tight text-gray-900 dark:text-white">Football Stadium {{ index }}</h5>
              </router-link>
              <!-- Card Description -->
              <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
              <!-- See Details Button -->
              <router-link :to="{ name: 'Detail', params: { id: index } }" class="me-2 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                See Details
              </router-link>
              <!-- Book Now Button -->
              <button @click="toggleDetails(index)" class="me-2 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Book Now
      ...
      <div v-if="showFieldDetails" class="max-w-5xl mx-auto px-4 py-8 w-full sm:w-3/4">
        ...
        <div class="flex gap-3">
          ...
          <button @click="toggleDetails()" class="py-2 px-5 bg-red-500 text-white rounded-lg shadow-md hover:bg-red-600 focus:outline-none">Back to Cards</button>
        </div>
      </div>
    </div>
  </template>
