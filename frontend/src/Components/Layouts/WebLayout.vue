<template>
  ...
  <div class="relative h-screen w-screen mb-5">
      ...
      <div class="text-center mx-auto">
        <p class="text-white text-lg md:text-3xl mb-4 font-bold">
          <strong
            ...
            "
            >W</strong
          >elcome to Football Field Booking
        </p>
        ...
        <div class="relative w-full">
          ...
          <button
            @click="searchFields"
            type="button"
            class="absolute right-0 top-0 bg-green-500 text-white px-4 py-2 rounded-md flex justify-center items-center gap-3"
          >
            <svg
    ...
    <div class="header-detail">
      <div
        class="form-select absolute p-2 mt-17 bg-green bg-opacity-90 z-20 rounded-lg w-full md:w-5/5 lg:w-9/10 ml-16 mobile-ml-hidden"
      >
        <div class="flex items-center justify-center space-x-2">
          <div class="relative flex gap-10 w-[334px]">
            ...
            <select
              ...
              class="flex-1 text-center pl-10 rounded-md text-black border-2 border-transparent focus:border-yellow-500"
              @change="handleChange"
              style="padding: 13px"
            >
  ...
  <div>
    <div
      ...
      class="card-me flex flex-wrap justify-start items-start ml-10"
    >
