    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('admin.fields.update', $field->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="field_size" name="field_size" value="{{ $field->field_size }}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="lighting_availability" id="lighting_yes" value="1" {{ $field->lighting_availability == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="lighting_yes">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="lighting_availability" id="lighting_no" value="0" {{ $field->lighting_availability == 0 ? 'checked' : '' }}>
