...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="lighting_availability" name="lighting_availability" value="{{ old('lighting_availability', $field->lighting_availability ?? '') }}" required>
</div>