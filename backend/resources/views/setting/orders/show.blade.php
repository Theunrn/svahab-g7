        ...
        <div class="max-w-md mx-auto bg-white rounded-xl shadow-lg overflow-hidden md:max-w-2xl">
            <div class="md:flex">
                <div class="md:flex-shrink-0">
                    <img class="h-48 w-full object-cover md:w-48" src="https://thumbs.dreamstime.com/b/online-purchase-logo-illustration-art-isolated-background-40522313.jpg" alt="Booking Image">
                </div>
                <div class="p-8">
                    <div class="uppercase tracking-wide text-2xl text-indigo-500 font-semibold mb-5">Order Details</div>
                    <h2 class="block mt-1 text-lg leading-tight font-medium text-black">Customer Name: {{ $order->customer->name }}</h2>
