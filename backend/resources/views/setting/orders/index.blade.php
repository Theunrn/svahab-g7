                            ...
                            <tr class="border-b">
                                ...
                                <td class="py-3 px-3 border-b border-gray-300">
                                    ...
                                    <div x-data="{ showModal: false }">
                                        <!-- Modal -->
                                        <button @click="showModal = true" class="bg-blue-500 text-xs hover:bg-blue-400 text-white font-bold py-1 px-3 border-blue-700 hover:border-blue-500 rounded">View</button>
                                        ...
                                        <div x-show="showModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
                                            <div class="bg-white rounded-lg p-6 w-1/2">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <p><strong>Order Date:</strong> {{ \Carbon\Carbon::parse($order->order_date)->isoFormat('dddd, D MMMM, YYYY') }}</p>
                                                </div>
                                                <div class="flex justify-end mt-4">
                                                    <button @click="showModal = false" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Close</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <a href="{{ route('admin.orders.confirm', $order->id) }}" class="bg-green-500 text-xs hover:bg-green-400 text-white font-bold py-1 px-3 rounded ml-1">Confirm</a>
                                    <a href="{{ route('admin.orders.cancel', $order->id) }}" class="bg-red-500 text-xs hover:bg-red-400 text-white font-bold py-1 px-3 rounded ml-1">Cancel</a>
                                    @else
                                    @endif
                                </td>
                            </tr>
