<x-guest-layout>
    <div class="container w-50 p-2 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700"
        ...
        <form @submit.prevent="submitPayment" id="payment-form">
            <div class="form-group mt-3">
                ...
                <input type="email" id="email" v-model="email" class="form-control" placeholder="xxxxxx@gmail.com"
                    required />
            </div>
            <div class="form-group mt-3">
            ...
            <div class="form-group mt-3">
                ...
                <div id="card-element" class="form-control">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="postal-code" v-model="postalCode" class="form-control"
